    ...
    <main>
        <div class="row">
                 <div class="col-lg-8 col1">
                     <div class="heading">WELCOME TO EKIRS JOB APPLICATION CBT CENTER</div>
                     <div class="heading_text py-2">
                         <p>Note that your username and password has been sent to you previously, enter these details and kindly click Login to continue.</p>
